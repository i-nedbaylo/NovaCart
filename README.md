...
**NovaCart** — учебно-демонстрационный интернет-магазин на микросервисной архитектуре .NET 10. Оплата и возврат симулируются; готовность к реальным платежам не заявляется.

Аудит и исправления от 20.09.2026: [результаты, проверки и условия обновления стенда](docs/audits/2026-09-20-fixes.md). При обновлении важны новая версия контракта оформления, миграция Ordering и сохраняемый Redis с AOF.
