...
## Исправления после аудита 20.09.2026

- [x] Исправлены замечания A01–A14 в исходниках; добавлены регрессионные тесты.
- [x] Проверены PostgreSQL/Redis и сквозной сценарий создания, оплаты и отмены заказа через Aspire.
- [x] Устранены известные уязвимости NuGet из аудита; CI отклоняет уязвимые пакеты и пропущенные интеграционные проверки.
- [ ] Выполнить браузерную приёмку интерактивной корзины и checkout.
- [ ] При обновлении существующего стенда применить миграцию и разобрать старые сообщения по [инструкции](audits/2026-09-20-fixes.md).

Эти отметки не подтверждают развёртывание, облачный CI или работу с реальным платёжным провайдером.
